...
// Norsk Tipping (Grasrotandelen) — Login's grassroots funding mark. Muted to
// greyscale by default, revealing its brand colours on hover of the parent link.
function NorskTippingIcon({ size = 24 }: LogfontIconProps) {
    return (
        <span
            aria-hidden='true'
        ...
        >
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='294.1897 0 466.6665 466.6665'
                width={size} height={size} className='block'>
                <g transform='matrix(1.3333333,0,0,-1.3333333,0,743.83867)'>
                    <path transform='translate(292.1823,557.8794)' fill='#ffc000'
                        d='M 0,0 -71.54,-71.539 31.939,-175 -71.54,-278.461 0,-350 175,-175 Z' />
                    <path transform='translate(220.6427,486.3399)' fill='#96d94e'
                        d='M 0,0 246.539,-103.461 H 103.479 Z' />
                    <path transform='translate(292.1823,557.8794)' fill='#00a332'
                        d='M 0,0 -71.54,-71.539 175,-175 Z' />
                    <path transform='translate(324.1212,382.8785)' fill='#ff7337'
                        d='m 0,0 -31.939,-175 175,175 z' />
                    <path transform='translate(499.104,557.8794)' fill='#ff7ea9'
                        d='m 0,0 -87.243,-87.243 71.539,-71.54 87.242,87.244 z' />
                    <path transform='translate(499.104,557.8794)' fill='#ef2500'
                        d='m 0,0 -15.704,-158.783 87.242,87.244 z' />
                    <path transform='translate(570.6422,279.4181)' fill='#00c1ff'
                        d='m 0,0 -87.243,87.243 -71.54,-71.539 87.244,-87.243 z' />
                    <path transform='translate(499.1031,207.879)' fill='#0058ff'
...
export const loginSocialLinks: FooterSocialLink[] = [
    ...
    { title: 'Norsk Tipping', href: 'https://www.norsk-tipping.no/grasrotandelen/din-mottaker/811940372',                icon: <NorskTippingIcon size={24} /> },
]
